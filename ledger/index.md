...
- [マグカップホルダー](designs/mug-holder.md) - 内径85.6mm・内高さ32.6mm、ハニカム排水底とクランプ板の回転止め
...
- [Gridfinity 4U/9U bin（薄いリップ・ラベル棚）](designs/gridfinity-bin-4u.md) - レターケースのベースプレートへ並べる4U/9Uの通常bin56種とgoodsのカードケース。両軸端数は除外。底は穴なし、リップは薄く、手前に12mmラベルシール用の13mm棚を持つ
