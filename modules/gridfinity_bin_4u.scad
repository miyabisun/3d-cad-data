...
// rows 1..5 × units 4 (assets に並ぶ 25 種)、カードケースが 2x3x4 (X 中央のポケット + 右奥の窪み + 交点の縦エッジの丸め)。 cols が X (横)、rows が Y
...
// カードケース (card_case_{c}x{r}x4u.scad) の値。カードは ISO/IEC 7810 ID-1 (85.6 × 54 ×
